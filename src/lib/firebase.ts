...
// Validation Connection Test (silent — errors handled by App.tsx)
async function testConnection() {
  try {
    await getDocFromServer(doc(db, 'test', 'connection'));
  } catch {
    // Silenced — Firebase may not be fully configured for localhost
  }
}
testConnection();

export { onAuthStateChanged, signInWithPopup, signOut, Timestamp };
