...
export function StarButton({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute inset-0 border-white/15 z-[4] overflow-hidden rounded-[inherit] text-white"
        style={{ borderWidth: "var(--border-width)" }}
        aria-hidden="true"
      >
        <StarBackground color={backgroundColor} />
      </div>
      <span className="z-10 relative text-white inline-block font-bold">
        {children}
      </span>
    </button>
  );
